...
| **Database Management**                | Attempt to read a table without the necessary privilege                                                         | Error Summary: Error: <br> AUTH-10008: Access denied: You need the READ privilege for the table sample_join_testing.audit_set to execute this operation. Transaction ID: 3219ad69-1e90-471d-a7ce-e8007c2e6332                                     |
|                                        | Attempt to write to a table without the necessary privilege                                                     | Error Summary: Error: <br> AUTH-10008: Access denied: You need the WRITE privilege for the table sample_join_testing.audit_set_collaborator to execute this operation. Transaction ID: 8b9876cd-c237-43d9-8e1e-ef9778036c7a                        |
|                                        | Attempt to delete from a table without the necessary privilege                                                  | Error Summary: Error: <br> AUTH-10008: Access denied: You need the DELETE privilege for the table sample_join_testing.audit_set_collaborator to execute this operation. Transaction ID: ee845e4d-86a8-4f10-8702-848703ba98e8                       |
